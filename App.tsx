  ...
  const handleSession = async (session: any) => {
      if (session?.user) {
          try {
              ...
              console.error("Server sync failed. Direct client-side fallback removed for security:", e.message || String(e));
              setSyncError(e.message || "Failed to synchronize user profile securely.");
