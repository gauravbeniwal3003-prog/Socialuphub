...
(async () => {
  ...
  await page.evaluate(() => {
    ...
    // Assuming identifier is first, password is second, wait, first input is honeypot!
    // The honeypot field is the first input!
    // Let's find inputs that are not hidden.
  ...
  } else if (html.includes('Overview')) {
